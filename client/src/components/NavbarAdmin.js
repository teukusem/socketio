      ...
      <Container>
        ...
        <NavbarComp.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto">
            ...
            <Nav.Link as={Link} to="/category-admin" className={props?.title == 'Category admin' ? `text-navbar-active` : `text-navbar`}>
              Category
            </Nav.Link>
            <Nav.Link as={Link} to="/product-admin" className={props?.title == 'Product admin' ? `text-navbar-active` : `text-navbar`}>
              Product
            </Nav.Link>
